CREATE TABLE devices (device_id TEXT PRIMARY KEY,name TEXT,firmware_version TEXT,boot_id TEXT,last_sequence INTEGER,status TEXT NOT NULL DEFAULT 'unknown',clock_synced INTEGER NOT NULL DEFAULT 0,last_seen_at INTEGER,desired_config_version INTEGER NOT NULL DEFAULT 0,applied_config_version INTEGER,created_at INTEGER NOT NULL,status_json TEXT);
...
CREATE TABLE plants (plant_id TEXT PRIMARY KEY,profile_id TEXT REFERENCES plant_profiles(profile_id),name TEXT NOT NULL,species TEXT,pot_volume_ml REAL,soil_type TEXT,auto_watering_enabled INTEGER NOT NULL DEFAULT 0,lockout_reason TEXT,lockout_since INTEGER,created_at INTEGER NOT NULL);
...
CREATE TABLE measurements (id INTEGER PRIMARY KEY AUTOINCREMENT,device_id TEXT NOT NULL REFERENCES devices(device_id),sensor_id TEXT,point TEXT NOT NULL DEFAULT 'default',kind TEXT NOT NULL,value_num REAL,value_bool INTEGER,unit TEXT NOT NULL,quality TEXT NOT NULL,calibration_ref TEXT,received_at INTEGER NOT NULL,device_time_ms INTEGER,boot_id TEXT,sequence INTEGER,batch_id TEXT NOT NULL,origin TEXT NOT NULL DEFAULT 'live');
...
CREATE TABLE replay_progress (device_id TEXT NOT NULL,boot_id TEXT NOT NULL,through_device_seq INTEGER NOT NULL DEFAULT 0,complete INTEGER NOT NULL DEFAULT 0,updated_at INTEGER NOT NULL,PRIMARY KEY(device_id,boot_id));
